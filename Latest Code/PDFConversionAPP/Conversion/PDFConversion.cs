...
namespace Conversion
{
    ...
    {
        public static void ConvertTOPdf(string Type, string sourcePath, string ExportPath, ref PdfDocument doc, int index)
        {
        ...
        public static void PDfMer(string ExportPath, string outFilePath)
        {
            ...
            string outFile = outFilePath+"\\" + Guid.NewGuid() + ".pdf";
